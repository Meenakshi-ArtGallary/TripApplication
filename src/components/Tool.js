...
function Tool() {
  ...
  const imageList = Array.from({ length:32 }, (_, i) => `${process.env.PUBLIC_URL}/aarufamily/yercaudtripaaru${i+1}.jpg`);
  ...
  return (
    <section>
      <h2>Aarumugam Family Pics...</h2>
      <p>Aarumugam Family Yercaud Pictures.</p>
      <div>
